...
<p align="center">
  <a href="https://github.com/Anush-Prabhu">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=680&lines=Hi%2C+I'm+Anush+%F0%9F%91%8B;MSSI+%40+Johns+Hopkins;Detection+%C2%B7+IAM+%C2%B7+RAG+%C2%B7+Automation;Open+to+security+%26+applied-AI+roles" alt="Typing SVG" />
  </a>
</p>
...
const anush = {
  ...
  education: "MSSI @ Johns Hopkins Whiting School of Engineering (May 2026)",
  focus: ["Security Engineering", "Detection & SIEM", "IAM Automation", "Applied AI / RAG"],
  experience: [
    "Johns Hopkins Hospital — Compliance / Data Quality & Privacy",
    "Jio Platforms — Security Analytics / Detection Engineering",
    "Johns Hopkins Medical Institutions — Privacy, Applied AI & Web Systems",
    "Bank of America — IAM Automation & Test Engineering",
    "Prabhu Tech — Founder (Web Platforms & Automation)"
  ],
  askMeAbout: [
    "detection engineering",
    "SIEM (Splunk / Wazuh)",
    "IAM / AD / Kerberos / gMSA",
    "guardrailed RAG",
    "privacy & compliance"
  ],
  stack: {
    languages: ["Python", "TypeScript", "JavaScript", "SQL", "PowerShell", "Bash"],
    security: ["Detection engineering", "Threat intel", "IAM validation", "SOC workflows"],
    cloud: ["Azure", "GCP", "OpenShift", "Linux / RHEL"],
    ai: ["RAG", "pgvector", "Neo4j", "guardrails", "fine-tuning"]
  },
  certs: ["CEH", "CHFI", "CCNA", "CyberOps", "DevNet", "CodePath CYB102", "CodePath AI201"],
  openToWork: true
};
```

- 🔭 Building security + applied-AI portfolio projects (detection, provenance, RAG)
- 🌱 Deepening production detection engineering and safe RAG patterns
- ⚡ Fun fact: I ship WordPress tooling *and* SOC prototypes — same week, different threat models
- 📫 Reach me: [LinkedIn](https://linkedin.com/in/anush-prabhu) · [anushprabhu4@gmail.com](mailto:anushprabhu4@gmail.com)
